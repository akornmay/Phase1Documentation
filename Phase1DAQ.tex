...
\cfchapter{Phase 1 DAQ Test Stand}{TestStand}{TestStand.tex}
...
\cfchapter{Tracker Front End Controler (tkFEC)}{pixFEC}{pixFEC.tex}
\cfchapter{Operating the DAQ System}{SystemOperation}{SystemOperation.tex}
\cfchapter{Debugging instructions}{Debugging}{Debugging.tex}
